...
<figcaption>上がジョブの成否、下が実際に出てくるデータ。ジョブは全部成功しているのに、出てくるものは止まっています。この状態を捕まえるのがこの記事の目的です。</figcaption>
</figure>
...
<figcaption>検出した項目は全部並べます（1個直して再実行、の往復を避けるため）。同じ通知で埋まらないよう、既に開いているIssueがあるときはコメントを足すだけにします。</figcaption>
</figure>
...
<figcaption>早すぎる監視は、遅れているだけのものを異常と判定します。誤報を出さないことは、検知することと同じくらい大事です。</figcaption>
</figure>
