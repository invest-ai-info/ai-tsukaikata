...
<figcaption>1日1回この順で動きます。最後の「要約済みを保存」を省くと、毎日同じ動画にAIの利用料を払い続けることになります。</figcaption>
</figure>
...
<figcaption>再生時間だけでは決まらないので3段で見ます。再生時間はData APIからしか取れず、これがRSSではなくAPIを使う理由の一つです。</figcaption>
</figure>
